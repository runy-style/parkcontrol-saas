  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="ambient-orb absolute -top-24 left-1/4 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[120px]" />
        <div
          className="ambient-orb absolute top-1/2 -right-24 w-[500px] h-[500px] bg-sky-500/10 rounded-full blur-[120px]"
          style={{ animationDelay: '-8s' }}
        />
        <div
          className="ambient-orb absolute -bottom-24 left-1/3 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[120px]"
          style={{ animationDelay: '-12s' }}
        />
      </div>

      {/* Header / Navigation Bar */}
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-zinc-950/80 border-b border-white/5 transition-all">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-12 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-amber-400 bg-amber-400/10 border border-amber-400/25 px-4 py-2 rounded-full mb-8 backdrop-blur-md shadow-lg shadow-amber-500/10">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.1] mb-6">
          ...
          <span className="text-gradient-amber">desde cualquier lugar</span>
        </h1>

        {/* Subtitle */}
        <p className="text-base sm:text-xl text-zinc-400 max-w-3xl mx-auto mb-10 leading-relaxed font-normal">
        ...
        {/* Highlights Bar */}
        <div className="mt-14 pt-8 border-t border-white/5 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-left">
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-zinc-300 font-medium">Cobro automático al segundo</span>
          </div>
          <div className="flex items-center gap-3">
            <CheckCircle2 className="w-5 h-5 text-sky-400 flex-shrink-0" />
            <span className="text-xs text-zinc-300 font-medium">Instalable como PWA Móvil</span>
          </div>
          <div className="flex items-center gap-3">
            <CheckCircle2 className="w-5 h-5 text-purple-400 flex-shrink-0" />
            <span className="text-xs text-zinc-300 font-medium">Datos 100% aislados y seguros</span>
          </div>
        </div>
      </section>

      {/* 2. DASHBOARD 3D PREVIEW SECTION */}
      <section id="dashboard-preview" className="relative z-10 max-w-7xl mx-auto px-6 py-12">
      ...
      <section id="features" className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-sky-400 bg-sky-400/10 border border-sky-400/20 px-4 py-1.5 rounded-full mb-3">
            Potencia Operativa
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 glass-card rounded-3xl p-8 border border-amber-500/20 hover:border-amber-500/40 transition-all group relative overflow-hidden">
          ...
          {/* Bento Item 2 */}
          <div className="glass-card rounded-3xl p-8 border border-sky-500/20 hover:border-sky-500/40 transition-all group">
          ...
          {/* Bento Item 3 */}
          <div className="glass-card rounded-3xl p-8 border border-emerald-500/20 hover:border-emerald-500/40 transition-all group">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Aislamiento total de datos con Supabase RLS. Los datos de tu estacionamiento permanecen 100% privados e inalcanzables por terceros.
            </p>
          </div>

          {/* Bento Item 4 */}
          <div className="glass-card rounded-3xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all group">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Instálala directamente en tu celular o tablet sin pasar por la App Store. Funciona perfecto desde el navegador móvil.
            </p>
          </div>

          {/* Bento Item 5 */}
          <div className="glass-card rounded-3xl p-8 border border-orange-500/20 hover:border-orange-500/40 transition-all group">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Crea perfiles separados para tus cajeros. El administrador mantiene control absoluto sobre quién accede y auditó cierres de caja.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="relative z-10 max-w-5xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 px-4 py-1.5 rounded-full mb-3">
      ...
      {/* 6. FOOTER SECTION */}
      <footer className="relative z-10 border-t border-white/5 py-12 text-center bg-zinc-950/90">
